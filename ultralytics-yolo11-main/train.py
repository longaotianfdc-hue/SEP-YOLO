...
if __name__ == '__main__':
    model = YOLO('yolo11-seg.yaml')# YOLO11
    # model = YOLO(r'F:\zfm\ultralytics-yolo11-main\runs\train\t10,mid\weights\last.pt') # YOLO11

    model.train(data=r'F:\zfm\ultralytics-yolo11-main\ultralytics\cfg\datasets\tm.yaml',
                cache=False,
                imgsz=640,
                epochs=100,
                batch=4,
