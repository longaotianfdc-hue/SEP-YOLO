...
if __name__ == '__main__':
    model_path = r'F:\zfm\ultralytics-yolo11-main\runs\train\glass_yolo11_best\weights\best.pt'
    model = YOLO(model_path) # 选择训练好的权重路径
    result = model.val(data=r'F:\zfm\ultralytics-yolo11-main\ultralytics\cfg\datasets\glass_vessel_detection.yaml',
